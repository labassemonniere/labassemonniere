...
export const rooms = [
  {
    ...
    description: [
      ...
      "Profitez de la terrasse privative, pour un moment de détente au calme de la campagne.",
...

  {
    ...
    description: [
      ...
      "Elle est équipée d'un lit de 160x200 cm, d'une salle d'eau avec douche à l'italienne et toilettes séparées.",
